...
export AbstractChebyshevSeries, ChebyshevSeries, Transformation, ChebyshevCluster, gradient, hessian, contains, normalize, clenshaw, gradient_clenshaw, hessian_clenshaw
...
# end
struct ChebyshevCluster{T, N, S<:Tuple{Vararg{ChebyshevSeries{T, N}}}} <: AbstractChebyshevSeries{T, N}
    series::S
end
...
# function contains(g::ChebyshevCluster{T, N, M}, x::SVector{N, T}) where {T, N, M}
#     for i in 1:M
#         if contains(g.series[i], x)
#             return i
#         end
